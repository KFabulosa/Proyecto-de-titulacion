...
dateForm.onsubmit = (event)=> {
    ...
    4. Del local Storage obtener el correo y mandarlo en el endpoint
    */

    axios.post('localhost:3000/meeting/add', {
        hour: hour,
        day: day
      })
      .then(function (response) {
        alert("Correo de cita enviado con éxito!");
      })
      .catch(function (error) {
        alert("Error inesperado. No se pudo agendar la cita.");
      });
}
